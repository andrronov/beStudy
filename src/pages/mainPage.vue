<template>
  ...
  <modalComponent v-if="isCreateTest">
    <div class="w-full z-40">
      <div class="max-w-7xl mx-auto flex flex-col items-center space-y-4 px-2 relative">
        <label for="testName" class="text-lg font-semibold">Test name</label>
        ...
        <button @click="createTest" class="px-4 py-3 bg-indigo-600 font-semibold text-xl text-white rounded-xl hover:bg-indigo-700">Create test</button>
        <button @click="isCreateTest = false" class="px-2 py-1 bg-indigo-800 text-white rounded-xl hover:bg-indigo-700">Back</button>
