<template>
   <div class="w-full">
     <div v-if="props.q_a" class="mx-auto w-full max-w-7xl rounded-2xl bg-white">
       <Disclosure v-for="(q_a, index) in props.q_a" :key="index" v-slot="{ open }">
         <DisclosureButton
         ...
         <DisclosurePanel class="px-4 pb-2 pt-4 text-sm text-gray-800">
           {{ q_a.a }}
         </DisclosurePanel>
       </Disclosure>
     </div>
